...
merged="${in_dir_merged}/UKB.autosomes.exome_array.shapeit5.ligated.polished.trio.vcf.gz"
pedigree="${in_dir_pedigree}/ukb_wes_200k_trios.ped"
out="UKB.autosomes.exome_array.shapeit5.ligated.polished.trio_ser_by_site"
