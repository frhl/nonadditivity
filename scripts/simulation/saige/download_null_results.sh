...
# note: this script downloads SAIGE null simulation combined results from DNAnexus

set -euo pipefail

# DNAnexus path
readonly dx_null_dir="/wes_ko_ukbb/data/saige/step2/simulated/revisions/051025/combined"
...
readonly local_null_dir="${local_base}/null_simulation_saige"

# Create local directory if it doesn't exist
mkdir -p "${local_null_dir}"

echo "====================================="
echo "Downloading SAIGE Null Simulation Results"
echo "====================================="
echo ""
