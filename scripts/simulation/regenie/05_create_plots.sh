...
# note: this script creates QQ plots from combined REGENIE results

readonly rscript_local="_create_plots.R"
readonly rscript_remote="wes_ko_ukbb/scripts/simulation/regenie/_create_plots.R"
...
# Define paths
readonly combined_dir="/wes_ko_ukbb/data/regenie/step2/simulated/revisions/051025/combined"
readonly out_dir="/wes_ko_ukbb/data/regenie/step2/simulated/revisions/051025/plots"
